# This class contains functions to generate layers
...
AOS_LAYER_OS ??= "${AOS_OS}"
AOS_LAYER_ARCH ??= "${AOS_ARCHITECTURE}"
...
do_create_layer[cleandirs] += "${ROOTFS_DIFF_DIR}"
do_create_layer[depends] += "${AOS_PARENT_LAYER}:do_create_shared_links"
do_create_layer[dirs] += "${AOS_LAYER_DEPLOY_DIR}"
